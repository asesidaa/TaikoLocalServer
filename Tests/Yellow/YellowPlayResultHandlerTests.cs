...
public sealed class YellowPlayResultHandlerTests
{
    ...
    public async Task UpdatePlayResult_Yellow_InvalidStagesDoNotUpdateSaveMetadataProfileOrNormalRows()
    {
        ...
        var invalidProfile = Ac15ProfileMutationFacts.Empty with
        {
            GetDonmedal = 50,
            GetKatsumedal = 60,
            ItemshopTutorialFlg = 7,
    ...
    public async Task UpdatePlayResult_Yellow_TokkunShapedPayloadReturnsSuccessWithoutNormalOrProfileWrites()
    {
        ...
        var request = Ac15PlayResultTestFactory.Command(
            1,
            GameEra.Yellow,
            playDatetime: "20260608120000",
    ...
    public async Task UpdatePlayResult_Yellow_NormalUploadIgnoresTokkunTutorialFlagAndSavesNormalPlay()
    {
        ...
        var result = await handler.Handle(Ac15PlayResultTestFactory.Command(
            ...
            tokkun: new Ac15TokkunPlayResult(TutorialFlg: 7, StageData: null),
            stages: [CreateStage(101, 1, 0)]),
            CancellationToken.None);
    ...
    public async Task UpdatePlayResult_Yellow_DaniReuploadKeepsBestAggregateAndStageValues()
    {
        ...
        var firstStages = new List<Ac15StageResult>
        {
        ...
        var secondStages = new List<Ac15StageResult>
        {
        ...
        uint secondPlayDan)
    {
        ...
        await fixture.Context.SaveChangesAsync();
        var handler = CreateHandler(fixture);
        List<Ac15StageResult> stages = secondPlayDan == 0
    ...
    public void PlayResultMapper_Yellow_MapsNormalWirePayloadIntoCommonData()
    {
        ...
        Assert.Equal(7u, envelope.Profile.ItemshopTutorialFlg);
        ...
        Assert.Equal(1u, envelope.Profile.AryCurrentCostume.Costume1);
        ...
        Assert.Equal(Difficulty.Easy, stage.Level);
    ...
    public void PlayResultMapper_Yellow_StageDataPreservesRawFactsButDoesNotClassifyWithoutTokkunPlayMode()
    {
        ...
        Assert.Equal("20260608120100", envelope.Tokkun.StageData!.BanacoinDatetime);
        ...
        Assert.Equal(3u, envelope.Tokkun.StageData.TokkunSpeedchangeCnt);
        Assert.Equal(4u, envelope.Tokkun.StageData.TokkunAutoplayCnt);
        Assert.Equal(5u, envelope.Tokkun.StageData.TokkunJumpCnt);
    }
