...
public sealed class BlueIdentityHandlerTests
{
    ...
    public async Task BaidQuery_Blue_ReturnsPersistedDanFlags()
    {
        ...
        save.GotDanFlg = Ac15DanHelpers.SetPackedGrade(save.GotDanFlg, 0, Ac15DanClearGrade.GoldClear, limits.DanFlagBytes);
        save.GotDanExtraFlg = Ac15DanHelpers.SetPackedGrade(save.GotDanExtraFlg, 0, Ac15DanClearGrade.NormalClear, limits.DanExtraFlagBytes);
        save.GotDanMax = 30;
        fixture.Context.UserSaveDataBlue.Add(save);
        await fixture.Context.SaveChangesAsync();
        var handler = new BaidQueryHandler(
