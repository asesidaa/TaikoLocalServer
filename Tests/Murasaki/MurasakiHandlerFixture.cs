...
internal sealed class MurasakiHandlerFixture : IAsyncDisposable
{
    private readonly SqliteConnection connection;

    private MurasakiHandlerFixture(SqliteConnection connection, TaikoDbContext context, IGameDataCatalog catalog)
    {
    ...
    public static async Task<MurasakiHandlerFixture> CreateAsync(IMurasakiCatalog? murasakiCatalog = null)
    {
        ...
        return new MurasakiHandlerFixture(connection, context, catalog);
    }
    ...
    internal sealed class TestMurasakiCatalog : IMurasakiCatalog
    {
        ...
        public uint SongHashVersion => 606;
        ...
        public IReadOnlyDictionary<uint, Ac15MusicInfoEntry> MurasakiMusicInfos
        ...
        public IReadOnlyDictionary<uint, Title> TitleDictionary { get; init; } =
            ...
            {
                [10] = new() { TitleId = 10, TitleName = "Murasaki Title", TitleRarity = 0 }
            };
