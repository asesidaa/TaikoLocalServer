...
public static partial class UserDataMappers
{
    ...
    private static uint? MapDispTaikojukuDan(Ac15UserDataResponse response) => NormalizeDispTaikojukuDan(response.Display.DispTaikojukuDan);
    ...
    private static uint? NormalizeDispTaikojukuDan(uint value) => value is >= 1 and <= 25 ? value : 1u;
}
