...
{
    private partial async ValueTask<CommonSelfBestResponse> HandleRed(
        GetSelfBestQuery request,
        CancellationToken cancellationToken)
    {
        var difficulty = MapRedDifficulty(request.Difficulty);
    ...
    private static Difficulty MapRedDifficulty(uint level) => level switch
    {
        1 => Difficulty.Easy,
        2 => Difficulty.Normal,
        3 => Difficulty.Hard,
