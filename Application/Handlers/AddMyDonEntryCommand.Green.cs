...
public partial class AddMyDonEntryCommandHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (await context.UserSaveDataGreen.FindAsync([baid], cancellationToken) is null)
        {
            context.UserSaveDataGreen.Add(UserSaveDataGreenExtensions.CreateDefaultGreenSaveData(baid));
        }
        ...
        logger.LogInformation("Created Green user {Baid} for access code {AccessCode}", baid, request.AccessCode);
