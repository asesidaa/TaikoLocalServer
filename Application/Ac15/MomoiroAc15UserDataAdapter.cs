...
public static class MomoiroAc15UserDataAdapter
{
    public static Ac15UserDataSnapshot CreateSnapshot(
        UserSaveDataMomoiro saveData,
    ...
    private static Ac15ProfileCounters Counters(UserSaveDataMomoiro saveData) => new()
    {
