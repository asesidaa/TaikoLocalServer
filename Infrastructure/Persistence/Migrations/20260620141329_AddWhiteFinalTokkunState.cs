...
{
    /// <inheritdoc />
    public partial class AddWhiteFinalTokkunState : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AddColumn<uint>(
                ...
                table: "UserSaveData_White",
                type: "INTEGER",
                nullable: true);

            migrationBuilder.CreateTable(
                name: "WhiteTokkunStageResults",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WhiteTokkunStageResults", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WhiteTokkunStageResults_UserData_Baid",
                        column: x => x.Baid,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WhiteTokkunStageResults_Baid_PlayDatetime",
                table: "WhiteTokkunStageResults",
