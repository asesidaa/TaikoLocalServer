...
{
    /// <inheritdoc />
    public partial class AddWhiteDonChallengeState : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "WhiteDonChallengeProgress",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WhiteDonChallengeProgress", x => new { x.Baid, x.BundleId, x.TaskId, x.TrackNo });
                    table.ForeignKey(
                        name: "FK_WhiteDonChallengeProgress_UserData_Baid",
                        column: x => x.Baid,
            ...
            migrationBuilder.CreateTable(
                name: "WhiteDonChallengeRawFacts",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WhiteDonChallengeRawFacts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WhiteDonChallengeRawFacts_UserData_Baid",
                        column: x => x.Baid,
                        principalTable: "UserData",
                        principalColumn: "Baid",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WhiteDonChallengeProgress_BundleId_TaskId_TrackNo",
                table: "WhiteDonChallengeProgress",
                columns: new[] { "BundleId", "TaskId", "TrackNo" });

            migrationBuilder.CreateIndex(
                name: "IX_WhiteDonChallengeRawFacts_Baid_BundleId_TaskId_TrackNo_PlayTime",
                table: "WhiteDonChallengeRawFacts",
