...
- `Tests/White/WhiteHostRouteGatingTests.cs` - Exercises MVC application-part route exposure for enabled/disabled White without source-file assertions.
...
- `Host/Program.cs` - Adds White using, conditional registration, disabled application-part removal, and exact `/v07r00/chassis` fallback.
...
**Total deviations:** 1 user-directed shape correction.
...
- Commits `66f746cd`, `e9cc1a32`, `e18cc26a`, and `05a63bfe` exist in git history.
