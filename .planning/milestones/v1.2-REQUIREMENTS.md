# Requirements Archive: v1.2 Yellow AC15 Support
...
- [x] **YVER-01**: Yellow support has focused route, nullable generated wire DTO, Mapperly-backed mapper, optional-field presence, catalog, handler, EF persistence, no-cross-era-write, no-battle, Tokkun, WaiWai, crown-encoding, AdminApi/WebUI, and AC15 shared-core regression tests.
- [x] **YVER-02**: Full server verification passes with `dotnet test Tests/Tests.csproj` and a temp-output Host build.
- [x] **YVER-03**: Yellow normal and Tokkun cabinet/RPCS3 smoke evidence is recorded before v1.2 is closed.
- [x] **YDOC-01**: Final Yellow route/state/semantic contract documentation records supported features, explicit non-goals, evidence gaps, and operator data expectations.
...
| YVER-01 | Phase 17 | Complete |
| YVER-02 | Phase 17 | Complete |
| YVER-03 | Phase 17 | Complete |
| YDOC-01 | Phase 17 | Complete |
...
*Last updated: 2026-06-12 after Phase 17 runtime verification and contract closeout*
