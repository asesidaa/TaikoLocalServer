...
- [x] **v1.6 KIMIDORI AC15 Support** - Phases 35-38 shipped on 2026-06-25. Define KIMIDORI 0.12 from `proto/kimidori`, `.tools/kimidori`, linked root-level game data, `/v01r00` startup/version routes, and `/v05r00` game routes.
...
**Current closeout state:** Phases 35-38 are complete. Phase 38 automated implementation is verified, user-observed KIMIDORI cabinet/RPCS3 runtime acceptance was recorded on 2026-06-25, and v1.6 shipped on 2026-06-25.
