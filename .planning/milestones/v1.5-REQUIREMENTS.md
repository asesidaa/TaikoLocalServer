# Requirements Archive: v1.5 Murasaki AC15 Support

**Archived:** 2026-06-23
**Status:** SHIPPED

The live `.planning/REQUIREMENTS.md` was removed at milestone close. The next milestone should create a fresh requirements file.
...
- [x] **MVER-03**: Murasaki support closes only after full automated verification, Mapperly generated-source inspection for nontrivial mappings, a Host build using temp output if needed, and user-accepted cabinet/RPCS3 and WebUI evidence for implemented Murasaki flows.
...
*Last updated: 2026-06-23 after user-accepted Murasaki in-game closeout and automated WebUI/AdminApi verification*
