...
- [x] **v1.2 Yellow AC15 Support** - Phases 12-17 plus inserted Phases 16.1 and 16.2 shipped on 2026-06-12. Yellow is a first-class older AC15 era with Blue-equivalent normal/Tokkun support where Yellow proto/data/runtime evidence supports it.

## Current Planning State

Active milestone: **none - v1.2 Yellow AC15 Support shipped on 2026-06-12**

**Goal completed:** Yellow is an era-owned AC15 adapter with Yellow protocol routes, local `ST9100-1` data, normal play, Dani, shop/medals, WaiWai tutorial/logging, Tokkun, compatibility routes, admin readback, and runtime verification, while keeping Blue battle behavior absent.
...
| 17 | Yellow Runtime Verification and Contract Closeout | Prove the full Yellow contract with focused tests, full build/test, runtime smoke, and docs. | YVER-01, YVER-02, YVER-03, YDOC-01 | Complete, 2026-06-12 |
...
- [x] **Phase 17: Yellow Runtime Verification and Contract Closeout** - Prove the full Yellow contract with focused tests, full build/test, runtime smoke, and docs. (completed 2026-06-12)
...
- [x] 17-01-PLAN.md - Record Yellow runtime verification and final contract closeout
...
| v1.2 Yellow AC15 Support | 12-17 plus 16.1 and 16.2 | 38 GSD plans complete | Shipped | 2026-06-12 |
