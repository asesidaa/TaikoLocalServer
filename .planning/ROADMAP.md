...
- [ ] **v1.5 Murasaki AC15 Support** - Phases 28-34 planned from current Murasaki proto, data, binary/client, and runtime evidence.
...
**Coverage:** 19/19 active v1.5 requirements mapped. Future `MLATER-01` and `MSPEC-04` remain deferred.
