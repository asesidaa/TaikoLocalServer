...
- [ ] **Phase 7: Tokkun Evidence Contract and Guardrail Reset** - Establish evidence-tagged Tokkun protocol boundaries and replace stale no-Tokkun guards.
...
|-------|-----------|----------------|--------|-----------|
| 7. Tokkun Evidence Contract and Guardrail Reset | v1.1 | 0/TBD | Not started | - |
