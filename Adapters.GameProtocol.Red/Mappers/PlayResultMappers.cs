...
public static partial class PlayResultMappers
{
    ...
    [MapperIgnoreTarget(nameof(CommonPlayResultData.GetDonmedal))]
    [MapperIgnoreTarget(nameof(CommonPlayResultData.GetKatsumedal))]
    [MapperIgnoreTarget(nameof(CommonPlayResultData.BonusDailyFlg))]
    [MapperIgnoreTarget(nameof(CommonPlayResultData.BonusWeeklyFlg))]
    [MapperIgnoreTarget(nameof(CommonPlayResultData.BonusMonthlyFlg))]
    [MapperIgnoreTarget(nameof(CommonPlayResultData.ItemshopTutorialFlg))]
    [MapperIgnoreTarget(nameof(CommonPlayResultData.WaiwaiTutorialFlg))]
    ...
    [MapperIgnoreTarget(nameof(CommonPlayResultData.StageData.WaiwaiResult))]
    [MapperIgnoreTarget(nameof(CommonPlayResultData.StageData.WaiwaiGauge))]
