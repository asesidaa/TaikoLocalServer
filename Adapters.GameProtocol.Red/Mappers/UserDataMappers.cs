...
public static partial class UserDataMappers
{
    ...
    [MapPropertyFromSource(nameof(UserDataResponse.DifficultyTutorialFlg), Use = nameof(MapDifficultyTutorialFlg))]
    [MapPropertyFromSource(nameof(UserDataResponse.TotalGetDonpoint), Use = nameof(MapTotalGetDonpoint))]
    [MapPropertyFromSource(nameof(UserDataResponse.TotalUseDonpoint), Use = nameof(MapTotalUseDonpoint))]
    [MapPropertyFromSource(nameof(UserDataResponse.RewardProgress), Use = nameof(MapRewardProgress))]
    ...
    private static uint? MapDifficultyTutorialFlg(Ac15UserDataResponse response) => response.Tutorial?.DifficultyTutorialFlg;
    private static uint? MapTotalGetDonpoint(Ac15UserDataResponse response) => response.Reward?.TotalGetDonpoint;
    private static uint? MapTotalUseDonpoint(Ac15UserDataResponse response) => response.Reward?.TotalUseDonpoint;
    private static uint? MapRewardProgress(Ac15UserDataResponse response) => response.Reward?.RewardProgress;
}
