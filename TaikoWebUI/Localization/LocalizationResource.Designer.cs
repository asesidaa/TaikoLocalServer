...
namespace TaikoWebUI.Localization {
    ...
    internal class LocalizationResource {
        ...
        ///   查找类似  的本地化字符串。
        /// </summary>
        internal static string Display_SouUchi_Songs {
            get {
                return ResourceManager.GetString("Display SouUchi Songs", resourceCulture);
            }
        }
        ...
        ///   查找类似  的本地化字符串。
        /// </summary>
        internal static string Gaiden_Title {
            get {
                return ResourceManager.GetString("Gaiden Title", resourceCulture);
            }
        }
